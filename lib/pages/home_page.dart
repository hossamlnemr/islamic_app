        ...
        Row(
          ...
          children: [
           ...
           SizedBox(width: 15.0,),
            ...
            SizedBox(height: 7.0,),
               Text('القران الكريم',style: TextStyle(
                color: Colors.green.shade900,
                fontSize: 15.0,
                fontWeight: FontWeight.w600,
               ),),
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Column(
                children: [
                  Checkbox(value: checkval, onChanged:(checkval){},shape:CircleBorder(),),
                  Text('العشاء',style: TextStyle(
                    color: Colors.green.shade900,
                    fontSize: 12.0,
                    fontWeight: FontWeight.w400,
                  ),),
                  Text('8:29',style: TextStyle(
                    color: Colors.green.shade900,
                    fontSize: 12.0,
                    fontWeight: FontWeight.w400,
                  ),)
